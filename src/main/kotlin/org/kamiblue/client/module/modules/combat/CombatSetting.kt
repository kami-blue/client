...
internal object CombatSetting : Module(
    ...
    private fun SafeClientEvent.updatePlacingList() {
        ...
        val cacheList = ArrayList<Pair<BlockPos, CombatManager.CombatCalculation>>()
        ...
        for (pos in getPlacePos(target, player, 8f)) {
            ...
            cacheList.add(Pair(pos, CombatManager.CombatCalculation(damage, selfDamage, dist)))
        }
    ...
    private fun SafeClientEvent.updateCrystalList() {
        ...
        val cacheList = ArrayList<Pair<EntityEnderCrystal, CombatManager.CombatCalculation>>()
        ...
        for (entity in world.loadedEntityList.toList()) {
            ...
            cacheList.add(entity to CombatManager.CombatCalculation(damage, selfDamage, dist))
        }
