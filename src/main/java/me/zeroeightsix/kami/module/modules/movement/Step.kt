...
object Step : Module(
    ...
    private val upStep = setting(getTranslationKey("UpStep"), true)
    private val downStep = setting(getTranslationKey("DownStep"), false)
    private val entityStep by setting(getTranslationKey("Entities"), true)
    private val height by setting(getTranslationKey("Height"), 1.0f, 0.25f..2.0f, 0.25f)
    private val downSpeed by setting(getTranslationKey("DownSpeed"), 0.2f, 0.0f..1.0f, 0.05f)
    private val bindUpStep by setting(getTranslationKey("BindUpStep"), Bind())
    private val bindDownStep by setting(getTranslationKey("BindDownStep"), Bind())
