...
object StashFinder : Module() {
    ...
    private val hopperDensity = register(Settings.integerBuilder("MinHoppers").withMinimum(1).withMaximum(20).withValue(5).withVisibility { logDispensers.value }.build())
