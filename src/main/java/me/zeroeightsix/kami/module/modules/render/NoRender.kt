...
object NoRender : Module(
    ...
    private val packets = setting(getTranslationKey("CancelPackets"), true)
    private val page = setting(getTranslationKey("Page"), Page.OTHER)

    // Entities
    private val paint = setting(getTranslationKey("Paintings"), false, { page.value == Page.ENTITIES })
    private val animals = setting(getTranslationKey("Animals"), false, { page.value == Page.ENTITIES })
    private val mobs = setting(getTranslationKey("Mobs"), false, { page.value == Page.ENTITIES })
    private val player = setting(getTranslationKey("Players"), false, { page.value == Page.ENTITIES })
    private val sign = setting(getTranslationKey("Signs"), false, { page.value == Page.ENTITIES })
    private val skull = setting(getTranslationKey("Heads"), false, { page.value == Page.ENTITIES })
    private val armorStand = setting(getTranslationKey("ArmorStands"), false, { page.value == Page.ENTITIES })
    private val endPortal = setting(getTranslationKey("EndPortals"), false, { page.value == Page.ENTITIES })
    private val banner = setting(getTranslationKey("Banners"), false, { page.value == Page.ENTITIES })
    private val itemFrame = setting(getTranslationKey("ItemFrames"), false, { page.value == Page.ENTITIES })
    private val xp = setting(getTranslationKey("XP"), false, { page.value == Page.ENTITIES })
    private val items = setting(getTranslationKey("Items"), false, { page.value == Page.ENTITIES })
    private val crystal = setting(getTranslationKey("Crystals"), false, { page.value == Page.ENTITIES })

    // Others
    val map = setting(getTranslationKey("Maps"), false, { page.value == Page.OTHER })
    private val explosion = setting(getTranslationKey("Explosions"), true, { page.value == Page.OTHER })
    val signText = setting(getTranslationKey("SignText"), false, { page.value == Page.OTHER })
    val particles = setting(getTranslationKey("Particles"), true, { page.value == Page.OTHER })
    private val falling = setting(getTranslationKey("FallingBlocks"), true, { page.value == Page.OTHER })
    val beacon = setting(getTranslationKey("BeaconBeams"), true, { page.value == Page.OTHER })
    val skylight = setting(getTranslationKey("SkyLightUpdates"), true, { page.value == Page.OTHER })
    private val enchantingTable = setting(getTranslationKey("EnchantingBooks"), true, { page.value == Page.OTHER })
    private val enchantingTableSnow = setting(getTranslationKey("EnchantTableSnow"), false, { page.value == Page.OTHER })
    private val projectiles = setting(getTranslationKey("Projectiles"), false, { page.value == Page.OTHER })
    private val lightning = setting(getTranslationKey("Lightning"), true, { page.value == Page.OTHER })
