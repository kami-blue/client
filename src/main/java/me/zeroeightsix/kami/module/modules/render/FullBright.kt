...
object FullBright : Module(
    ...
    private val gamma by setting(getTranslationKey("Gamma"), 12.0f, 5.0f..15.0f, 0.5f)
    private val transitionLength by setting(getTranslationKey("TransitionLength"), 3.0f, 0.0f..10.0f, 0.5f)
    private var oldValue by setting(getTranslationKey("OldValue"), 1.0f, 0.0f..1.0f, 0.1f, { false })
