...
object StashLogger : Module(
    ...
    private val saveToFile by setting(getTranslationKey("SaveToFile"), true)
    private val logToChat by setting(getTranslationKey("LogToChat"), true)
    private val playSound by setting(getTranslationKey("PlaySound"), true)
    private val logChests by setting(getTranslationKey("Chests"), true)
    private val chestDensity by setting(getTranslationKey("MinChests"), 5, 1..20, 1, { logChests })
    private val logShulkers by setting(getTranslationKey("Shulkers"), true)
    private val shulkerDensity by setting(getTranslationKey("MinShulkers"), 1, 1..20, 1, { logShulkers })
    private val logDroppers by setting(getTranslationKey("Droppers"), true)
    private val dropperDensity by setting(getTranslationKey("MinDroppers"), 5, 1..20, 1, { logDroppers })
    private val logDispensers by setting(getTranslationKey("Dispensers"), true)
    private val dispenserDensity by setting(getTranslationKey("MinDispensers"), 5, 1..20, 1, { logDispensers })
    private val logHoppers by setting(getTranslationKey("Hoppers"), true)
    private val hopperDensity by setting(getTranslationKey("MinHoppers"), 5, 1..20, 1, { logHoppers })
