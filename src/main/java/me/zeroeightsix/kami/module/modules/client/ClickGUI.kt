...
object ClickGUI : Module(
    ...
    private val scaleSetting = setting(getTranslationKey("Scale"), 100, 50..400, 5)
    val blur by setting(getTranslationKey("Blur"), 0.0f, 0.0f..1.0f, 0.05f)
    val darkness by setting(getTranslationKey("Darkness"), 0.25f, 0.0f..1.0f, 0.05f)
    val fadeInTime by setting(getTranslationKey("FadeInTime"), 0.25f, 0.0f..1.0f, 0.05f)
    val fadeOutTime by setting(getTranslationKey("FadeOutTime"), 0.1f, 0.0f..1.0f, 0.05f)
