...
object DiscordRPC : Module(
    ...
    private val line1Left by setting(getTranslationKey("Line1Left"), LineInfo.VERSION) // details left
    private val line1Right by setting(getTranslationKey("Line1Right"), LineInfo.USERNAME) // details right
    private val line2Left by setting(getTranslationKey("Line2Left"), LineInfo.SERVER_IP) // state left
    private val line2Right by setting(getTranslationKey("Line2Right"), LineInfo.HEALTH) // state right
    private val coordsConfirm by setting(getTranslationKey("CoordsConfirm"), false, { showCoordsConfirm() })
