...
object ClickGUI : Module() {
    ...
    val darkNess = register(Settings.floatBuilder("Darkness").withValue(0.25f).withRange(0f, 1f).withStep(0.05f))
    val alpha = register(Settings.floatBuilder("Alpha").withValue(0.5f).withRange(0f, 1f).withStep(0.05f))
    val shadow = register(Settings.floatBuilder("Shadow").withValue(0.5f).withRange(0f, 2f).withStep(0.05f))
