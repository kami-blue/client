...
@Info(name = "AutoNicety", category = Category.MISC, description = "Tells players that they are dumb")
public class AutoNicety extends Module
{
    ...
    private void sendMessage(final Entity entityIn) {
        Minecraft.func_71410_x().field_71442_b.field_78774_b.func_147297_a((Packet)new CPacketChatMessage("/w " + entityIn.func_70005_c_() + " Hi! " + entityIn.func_70005_c_() + ", Have you lost weight?"));
    }
    
    private enum AutoNicetyMode
    {
        PRIVATE, 
        PUBLIC;
    }
