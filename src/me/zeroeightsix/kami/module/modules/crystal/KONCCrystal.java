...
@Info(name = "KONC-Crystal", category = Category.CRYSTAL)
public class KONCCrystal extends Module
{
    ...
    public KONCCrystal() {
        ...
        this.Pdelay = this.register(Settings.d("Place Delay", 0.0));
        this.Bdelay = this.register(Settings.d("Break Delay", 0.0));
        this.distance = this.register(Settings.d("Enemy Distance", 13.0));
        ...
        this.packetListener = new Listener<PacketEvent.Send>(event -> {
            ...
            if (packet instanceof CPacketPlayer && KONCCrystal.isSpoofingAngles) {
                ((CPacketPlayer)packet).field_149476_e = (float)KONCCrystal.yaw;
                ((CPacketPlayer)packet).field_149473_f = (float)KONCCrystal.pitch;
            }
    ...
    public void onUpdate() {
        final EntityEnderCrystal crystal = (EntityEnderCrystal)KONCCrystal.mc.field_71441_e.field_72996_f.stream().filter(entity -> entity instanceof EntityEnderCrystal).map(entity -> entity).min(Comparator.comparing(c -> KONCCrystal.mc.field_71439_g.func_70032_d(c))).orElse(null);
        if (this.explode.getValue() && crystal != null && KONCCrystal.mc.field_71439_g.func_70032_d((Entity)crystal) <= this.range.getValue()) {
            if (System.nanoTime() / 1000000L - this.systemTime >= this.Bdelay.getValue()) {
                if (this.antiWeakness.getValue() && KONCCrystal.mc.field_71439_g.func_70644_a(MobEffects.field_76437_t)) {
                    if (!this.isAttacking) {
                ...
                this.lookAtPacket(crystal.field_70165_t, crystal.field_70163_u, crystal.field_70161_v, (EntityPlayer)KONCCrystal.mc.field_71439_g);
                KONCCrystal.mc.field_71442_b.func_78764_a((EntityPlayer)KONCCrystal.mc.field_71439_g, (Entity)crystal);
                KONCCrystal.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
        ...
        int crystalSlot = (KONCCrystal.mc.field_71439_g.func_184614_ca().func_77973_b() == Items.field_185158_cP) ? KONCCrystal.mc.field_71439_g.field_71071_by.field_70461_c : -1;
        if (crystalSlot == -1) {
            for (int l = 0; l < 9; ++l) {
                if (KONCCrystal.mc.field_71439_g.field_71071_by.func_70301_a(l).func_77973_b() == Items.field_185158_cP) {
                    crystalSlot = l;
                    break;
                }
            }
        ...
        if (KONCCrystal.mc.field_71439_g.func_184592_cb().func_77973_b() == Items.field_185158_cP) {
            offhand = true;
        }
        ...
        if (this.players.getValue()) {
            entities.addAll((Collection<? extends Entity>)KONCCrystal.mc.field_71441_e.field_73010_i.stream().filter(entityPlayer -> !Friends.isFriend(entityPlayer.func_70005_c_())).collect(Collectors.toList()));
        }
        final boolean b2;
        entities.addAll((Collection<? extends Entity>)KONCCrystal.mc.field_71441_e.field_72996_f.stream().filter(entity -> {
        ...
        for (final Entity entity2 : entities) {
            if (entity2 != KONCCrystal.mc.field_71439_g) {
                ...
                for (final BlockPos blockPos : blocks) {
                    ...
                    final double self = calculateDamage(blockPos.field_177962_a + 0.5, blockPos.field_177960_b + 1, blockPos.field_177961_c + 0.5, (Entity)KONCCrystal.mc.field_71439_g);
                    if (self > d && d >= ((EntityLivingBase)entity2).func_110143_aJ()) {
                        continue;
                    }
                    if (self - 0.5 > KONCCrystal.mc.field_71439_g.func_110143_aJ()) {
                        continue;
                    }
        ...
        if (this.place.getValue()) {
            if (!offhand && KONCCrystal.mc.field_71439_g.field_71071_by.field_70461_c != crystalSlot) {
                if (this.autoSwitch.getValue()) {
                    KONCCrystal.mc.field_71439_g.field_71071_by.field_70461_c = crystalSlot;
                    resetRotation();
                    this.switchCooldown = true;
                }
                return;
            }
            this.lookAtPacket(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5, (EntityPlayer)KONCCrystal.mc.field_71439_g);
            EnumFacing f;
            if (this.raytrace.getValue()) {
                final RayTraceResult result = KONCCrystal.mc.field_71441_e.func_72933_a(new Vec3d(KONCCrystal.mc.field_71439_g.field_70165_t, KONCCrystal.mc.field_71439_g.field_70163_u + KONCCrystal.mc.field_71439_g.func_70047_e(), KONCCrystal.mc.field_71439_g.field_70161_v), new Vec3d(q.field_177962_a + 0.5, q.field_177960_b - 0.5, q.field_177961_c + 0.5));
            ...
            if (System.nanoTime() / 1000000L - this.systemTime >= this.Pdelay.getValue()) {
                KONCCrystal.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerTryUseItemOnBlock(q, f, offhand ? EnumHand.OFF_HAND : EnumHand.MAIN_HAND, 0.0f, 0.0f, 0.0f));
                ++this.placements;
                this.systemTime = System.nanoTime() / 1000000L;
            }
        }
        if (KONCCrystal.isSpoofingAngles) {
            if (KONCCrystal.togglePitch) {
                final EntityPlayerSP field_71439_g = KONCCrystal.mc.field_71439_g;
                field_71439_g.field_70125_A += (float)4.0E-4;
                KONCCrystal.togglePitch = false;
            }
            else {
                final EntityPlayerSP field_71439_g2 = KONCCrystal.mc.field_71439_g;
                field_71439_g2.field_70125_A -= (float)4.0E-4;
                KONCCrystal.togglePitch = true;
            }
        }
    }
    ...
    private boolean canPlaceCrystal(final BlockPos blockPos) {
        ...
        return (KONCCrystal.mc.field_71441_e.func_180495_p(blockPos).func_177230_c() == Blocks.field_150357_h || KONCCrystal.mc.field_71441_e.func_180495_p(blockPos).func_177230_c() == Blocks.field_150343_Z) && KONCCrystal.mc.field_71441_e.func_180495_p(boost).func_177230_c() == Blocks.field_150350_a && KONCCrystal.mc.field_71441_e.func_180495_p(boost2).func_177230_c() == Blocks.field_150350_a && KONCCrystal.mc.field_71441_e.func_72872_a((Class)Entity.class, new AxisAlignedBB(boost)).isEmpty() && KONCCrystal.mc.field_71441_e.func_72872_a((Class)Entity.class, new AxisAlignedBB(boost2)).isEmpty();
    }
    
    public static BlockPos getPlayerPos() {
        return new BlockPos(Math.floor(KONCCrystal.mc.field_71439_g.field_70165_t), Math.floor(KONCCrystal.mc.field_71439_g.field_70163_u), Math.floor(KONCCrystal.mc.field_71439_g.field_70161_v));
    }
    ...
    public static float calculateDamage(final double posX, final double posY, final double posZ, final Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            finald = getBlastReduction((EntityLivingBase)entity, getDamageMultiplied(damage), new Explosion((World)KONCCrystal.mc.field_71441_e, (Entity)null, posX, posY, posZ, 6.0f, false, true));
        }
        return (float)finald;
    }
    ...
    private static float getDamageMultiplied(final float damage) {
        final int diff = KONCCrystal.mc.field_71441_e.func_175659_aa().func_151525_a();
    ...
    private static void setYawAndPitch(final float yaw1, final float pitch1) {
        KONCCrystal.yaw = yaw1;
        KONCCrystal.pitch = pitch1;
        KONCCrystal.isSpoofingAngles = true;
    }
    
    private static void resetRotation() {
        if (KONCCrystal.isSpoofingAngles) {
            KONCCrystal.yaw = KONCCrystal.mc.field_71439_g.field_70177_z;
            KONCCrystal.pitch = KONCCrystal.mc.field_71439_g.field_70125_A;
            KONCCrystal.isSpoofingAngles = false;
        }
    }
    ...
    protected void onEnable() {
        if (this.alert.getValue()) {
            Command.sendChatMessage(" §eKONCCrystal §aON");
        }
    }
    
    public void onDisable() {
        if (this.alert.getValue()) {
            Command.sendChatMessage(" §eKONCCrystal §4OFF");
        }
        this.render = null;
        this.renderEnt = null;
        resetRotation();
